...
import { Trash, Archive, X, LinkIcon, Facebook, MessageCircle, Music, Youtube } from 'lucide-react';
import { useSelector } from 'react-redux';
import { RootState } from '@/lib/store';
import { useDeleteLinkMutation, useRestoreLinkMutation } from '@/@core/infra/api/linksApi';
...
export default function ArchivedLinkCard({ id }: ArchivedLinkCardProps) {
    ...
    const [showConfirmation, setShowConfirmation] = useState<'delete' | 'restore' | null>(null);
            ...
            <CardContent className="flex flex-col p-4">
                ...
                {showConfirmation === 'restore' && (
                    <div className="flex flex-col mt-4 w-full">
                        ...
                        <span className="self-center mb-4 text-xs text-gray-600 mt-2 text-center">Restore this link to your Linktree</span>
                ...
                {showConfirmation === 'delete' && (
                    <div className="flex flex-col mt-4 w-full">
                        ...
                        <span className="self-center mb-4 text-xs text-gray-600 mt-2 text-center">Permanently delete this link and its analytics data?</span>
