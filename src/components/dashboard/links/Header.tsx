        ...
        <header className="mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 min-h-[100px]">
            {data?.username ? (
                <>
                    ...
                    <Button variant="outline" onClick={copyToClipboard} className="whitespace-nowrap">
                        {copied ? (
                            <>
                ...
                <>
                    <h1 className="text-2xl font-bold text-center sm:text-left">Your Linktree is not live yet</h1>
